<template>
  <section class="formation-detail position-relative text-white">
    ...
    <div class="container py-5 position-relative" data-aos="fade-up">
      <h2 class="text-center mb-4 text-danger fw-bold">Informatique</h2>
    ...
    return {
      ...
      infos: [
        ...
        { label: 'Langue', value: 'Français' },
        {
          ...
          value:
            'Matheleme, Science-Experimental, Math-Technique.',
        },
        { label: 'Point fort', value: 'Emploi du temps conforme aux recommandations du MESRS.' },
      ],
      description:
        'La licence en informatique que propose l\'IFAG est axée sur les compétences académiques et les méthodes de travail essentielles pour divers domaines du numérique. Grâce à une pédagogie active, vous participerez à des projets concrets, des travaux pratiques, et des recherches collaboratives, favorisant créativité, innovation et communication. ',
      sections: [
        {
          ...
          content: [
            ...
            'Analyser et modéliser des problèmes pour implémenter des solutions.',
            'Analyser et modéliser des problèmes pour implémenter des solutions.',
            'Rédiger la documentation technique pour développeurs et utilisateurs.',
        ...
        },
        {
          ...
          content: [
            ...
            'Compétences en gestion de projet et travail en équipe.',
