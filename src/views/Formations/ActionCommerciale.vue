<template>
  <section class="formation-detail position-relative text-white">
    ...
    <div class="container py-5 position-relative" data-aos="fade-up">
      <h2 class="text-center mb-4 text-danger fw-bold">Action Commerciale</h2>
    ...
    return {
      ...
      infos: [
        ...
        { label: 'Langue', value: 'Français' },
        {
          ...
          value:
            'Science-Experimental, matheleme, Math-Technique, Gestion-économie, Langues étrangère.',
        },
        { label: 'Point fort', value: 'Stage obligatoire dès la 1ère année' },
      ],
      stats: [
        { label: 'des diplômés sont en poste', value: 95.76 },
        { label: 'travaillent dans des multinationales', value: 36.9 },
        { label: 'dans des grandes entreprises', value: 26.2 },
        { label: 'dans les PME/PMI', value: 23.1 },
      ],
      animatedStats: [0, 0, 0, 0], // start from 0
      hasAnimated: false,
      description:
        'La formation en Action Commerciale forme des professionnels capables de comprendre les besoins du marché, de proposer des solutions commerciales efficaces et de maîtriser l’ensemble du cycle de vente.',
      sections: [
        {
        ...
        },
        {
          ...
          list: false,
          content:
            'À l’issue de la formation, les diplômés pourront exercer des métiers tels que : Assistant commercial, Chargé de clientèle, Responsable de secteur, Télévendeur, etc.',
        },
        {
          ...
          content: [
            ...
            'Stages professionnels chaque année.',
            'Participation à des projets réels et cas pratiques.',
          ],
        },
      ],
    }
...
<style scoped>
.formation-detail {
  background: url('/ActionCommercial/AC.png') center bottom / 100% no-repeat fixed;
  min-height: 100vh;
  padding: 20px;
