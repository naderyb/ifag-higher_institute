<template>
  <section class="formation-detail position-relative text-white">
    ...
    <div class="container py-5 position-relative" data-aos="fade-up">
      <h2 class="text-center mb-4 text-danger fw-bold">Finance et Comptabilité</h2>
  ...
  data() {
    return {
      ...
      infos: [
        ...
        {
          label: 'Filières acceptées',
          value: 'Matheleme, Science-Experimental, Math-Technique, Gesion et économie.',
        },
        { label: 'Point fort', value: 'Emploi du temps conforme aux recommandations du MESRS.' },
      ],
      description:
        'La licence en Finance et Comptabilité de l\'IFAG offre une formation théorique et pratique en comptabilité, finance, gestion financière, fiscalité, contrôle de gestion, audit et droit des affaires. Grâce aux études de cas et logiciels spécialisés, les étudiants développent des compétences clés. Le programme culmine avec un projet de fin d’études, préparant à des carrières spécialisées ou études avancées en finance. Cette formation forme des professionnels compétents, innovants et éthiquement responsables pour le secteur financier mondial.',
      sections: [
        {
          title: 'Objectifs pédagogiques',
          list: true,
          content: [
            'Maîtrise des aspects comptables et financiers.',
            'Bases solides en comptabilité, finance, contrôle de gestion et audit.',
            'Préparation aux carrières en comptabilité et finance.',
            'Compétences pour réussir les examens d’expertise comptable.',
            'Superviser et analyser le fonctionnement des systèmes et réseaux.',
          ],
        },
        {
...
<style scoped>
.formation-detail {
  background: url('/Informatique/CS.png') center center / 100% no-repeat fixed;
  min-height: 100vh;
  padding: 20px;
